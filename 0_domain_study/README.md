...
Problem Statement
Middle-income and developing countries face a critical question: What mix of economic conditions, governance quality, infrastructure readiness, and human-capital capacity enables them to attract consistent, high-quality foreign investment? Despite a large body of research, there remains no unified, open-source, data-driven framework that brings these factors together into a coherent, comparable scoring system.
...
•	UNCTAD World Investment Reports — https://unctad.org/publications/world-investment-report
•	UNCTADstat (FDI flows & stocks) — https://unctadstat.unctad.org
...
•	IMF Data (BOP, macro indicators) — https://www.imf.org/en/Data
•	Transparency International Corruption Perceptions Index (CPI) — https://www.transparency.org/en/cpi
•	ILO & ILOSTAT (Labor force, wages, skills) — https://ilostat.ilo.org
•	Logistics Performance Index (LPI) — https://lpi.worldbank.org/
•	IEA Energy Data (Electricity prices, reliability) — https://www.iea.org/data-and-statistics
•	IRENA Renewable Energy Data — https://www.irena.org/Data
•	Dunning, J. H. “The Eclectic Paradigm of International Production.” Journal of International Business Studies.
•	Alfaro, L., et al. “FDI and Economic Growth.” Journal of International Economics.
•	OECD. FDI in Figures.
These materials collectively inform the theoretical and empirical basis of the project.
________________________________________
